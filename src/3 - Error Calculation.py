...
files = {
    'Gravity1': 'gravity_flows_1.csv',
    'Gravity2': 'gravity_flows_2.csv',
    'Gravity3': 'gravity_flows_3.csv',
    'Gravity4': 'gravity_flows_4.csv',
    'Gravity5': 'gravity_flows_5.csv',
    'Gravity6': 'gravity_flows_6.csv',
}
